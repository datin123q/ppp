...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		Media media = new Media(getClass().getResource("sound1.mp3").toString());
        ...
        ImageView imageView = new ImageView(image);
			...
			InputStream input1 = getClass().getResourceAsStream("/images/start.png");
			...
			InputStream input2 = getClass().getResourceAsStream("/images/music.png");
	        ...
	        but3.setOnAction(new EventHandler<ActionEvent>() {
	            ...
	            public void handle(ActionEvent event) {
	                ...
	                Label secondLabel = new Label("/abouttext");
	                BufferedReader br = null;
	    			try {
	    				br = new BufferedReader(new FileReader(new File(
	    						"C:/Users/Admin/eclipse-workspace/shippp/src/application/users.txt")));
